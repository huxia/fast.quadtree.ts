...
export declare namespace Collection {
    ...
    function toIterable<T>(...childIterators: (undefined | (() => Collection<T>))[]): Generator<T, void, unknown>;
    function toIterableWithFilter<T>(filterFunc: ((o: T, idx: number) => boolean), index: {
        index: number;
    }, ...childIterators: (undefined | Collection<T> | (() => Collection<T>))[]): Generator<T, void, unknown>;
    function toIterableWithMap<T, A>(mapFunc: ((o: T, idx: number) => A), index: {
        index: number;
    }, ...childIterators: (undefined | Collection<T> | (() => Collection<T>))[]): Generator<A, void, unknown>;
